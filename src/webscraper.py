...
def scrape_data():
    ...
    klasa = None
    for i in range (11000, len(soup_string)): # 11,076 is I, so class is 11,077, but it's better to have slight error margin
